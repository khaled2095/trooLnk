...
<head>
    ...
    <?php endif ?>
    <link href="<?= SITE_URL . ASSETS_URL_PATH . 'vendor/animate/animate.css' ?>" rel="stylesheet" media="screen,print" rel="stylesheet" media="screen,print">
    <link href="<?= SITE_URL . ASSETS_URL_PATH . 'vendor/owl-carousel/css/owl.carousel.min.css' ?>" rel="stylesheet" media="screen,print" rel="stylesheet" media="screen,print">
    <!-- <link href="<?= SITE_URL . ASSETS_URL_PATH . 'vendor/bootstrap.css' ?>" rel="stylesheet" media="screen,print" rel="stylesheet" media="screen,print">
    <link href="<?= SITE_URL . ASSETS_URL_PATH . 'vendor/mobster.css' ?>" rel="stylesheet" media="screen,print" rel="stylesheet" media="screen,print"> -->
    <link href="<?= SITE_URL . ASSETS_URL_PATH . 'vendor/maicons.css' ?>" rel="stylesheet" media="screen,print" rel="stylesheet" media="screen,print">
