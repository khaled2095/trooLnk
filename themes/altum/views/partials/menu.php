        ...
        <div class="collapse navbar-collapse justify-content-end" id="main_navbar">
            <ul class="navbar-nav">
                ...
                <?php else : ?>
                    ...
                    <li class="nav-item active mr-2"><a class="btn btn-primary rounded-pill" href="<?= url('login') ?>"><i class="fa fa-fw fa-sm fa-sign-in-alt mr-1"></i> <?= $this->language->login->menu ?></a></li>

                    <?php if ($this->settings->register_is_enabled) : ?>
                        <li class="nav-item active"><a class="btn btn-primary rounded-pill" href="<?= url('register') ?>"><i class="fa fa-fw fa-sm fa-plus mr-1"></i> <?= $this->language->register->menu ?></a></li>
                    <?php endif ?>
