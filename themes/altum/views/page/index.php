...
<div id='custom-pages'>
    ...
    <div class="bread" style="background-image: url('<?= SITE_URL . ASSETS_URL_PATH . 'images/hero_mini.svg' ?>');">
        <nav aria-label="breadcrumb" class="container" id='bread'>
            <h1 class="mb-5" style="color: white;"><?= $data->page->title ?></h1>
            <small>
                <ol class="custom-breadcrumbs">
                    <li><a href="<?= url() ?>"><?= $this->language->index->breadcrumb ?></a> <i class="fa fa-fw fa-angle-right"></i></li>
                    <li><a href="<?= SITE_URL . 'pages' ?>"><?= $this->language->pages->index->breadcrumb ?></a> </i></li>
