                ...
                <form name="create_link" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="url" placeholder="<?= $this->user->package_settings->custom_url ? $this->language->create_link_modal->input->url_placeholder_custom : $this->language->create_link_modal->input->url_placeholder ?>" <?= !$this->user->package_settings->custom_url ? 'readonly="readonly"' : null ?> />
                        </div>
                ...
                <form name="create_biolink" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="url" placeholder="<?= $this->user->package_settings->custom_url ? $this->language->create_biolink_modal->input->url_placeholder_custom :  $this->language->create_biolink_modal->input->url_placeholder ?>" <?= !$this->user->package_settings->custom_url ? 'readonly="readonly"' : null ?> />
                        </div>
