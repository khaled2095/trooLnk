                ...
                if(isset($response)) {
                    ...
                    /* Create a new account */
                        ...
                        if(empty($_SESSION['error'])) {
                            ...
                            $stmt = Database::$database->prepare("INSERT INTO `users` (`password`, `email`, `name`, `facebook_id`, `package_id`, `package_expiration_date`, `package_settings`, `language`, `timezone`, `active`, `date`, `ip`, `country`, `last_user_agent`, `total_logins`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                            $stmt->bind_param('sssssssssssssss', $password, $email, $name, $facebook_user_id, $package_id, $package_expiration_date, $package_settings, Language::$language, $timezone, $active, \Altum\Date::$date, $ip, $country, $user_agent, $total_logins);
                            $stmt->execute();
