        ...
        <nav aria-label="breadcrumb">
            <small>
                <ol class="custom-breadcrumbs">
                    ...
                    <li class="active" aria-current="page"><?= $this->language->package->breadcrumb ?></li>
                </ol>
            </small>
        </nav>

        <?php if(\Altum\Middlewares\Authentication::check() && $this->user->package_is_expired && $this->user->package_id != 'free'): ?>
